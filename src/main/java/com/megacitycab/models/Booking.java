...
public class Booking {
    ...
    public Booking(int id, String customerUsername, int carId, String driverUsername, String pickupLocation, String dropoffLocation, String status) {
        this.id = id;
    ...
    public Booking(int id, String customerUsername, int carId, String carNumber, String carName, String carImage,
                   String driverUsername, String driverImage, String pickupLocation, String dropoffLocation, String status) {
        this.id = id;
        this.customerUsername = customerUsername;
        this.carId = carId;
